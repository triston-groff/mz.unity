...
M.n = as.data.frame(matrix(c(
  +1, atm$h1$m, 0.9, 0,
  +1, (atm$na23$m - atm$h1$m), 0.8, 1,
  +1, (atm$k39$m - atm$h1$m), 0.7, 1,
  0, (atm$h1$m*2+atm$o16$m), 0.6, 0,
  0, -(atm$c12$m + atm$o16$m*2), 0.4, 1,
  0, (atm$n14$m + atm$h1$m*3), 0.4, 0,
  0, +(atm$c12$m + atm$o16$m*2 + atm$h1$m*2), 0.6, 1,
  0, +(atm$c12$m*2 + atm$h1$m*4 + atm$o16$m*2), 0.6, 1,
  0, +(atm$c12$m*2 + atm$h1$m*3 + atm$n14$m), 0.3, 0,
  0, +(atm$c12$m + atm$h1$m*4 + atm$o16$m), 0.3, 0,
  0, -(atm$c12$m + atm$o16$m), 0.3, 0,
  0, +(atm$h1$m*3 + atm$p31$m + atm$o16$m*4), 0.1, 0
...
M.n.specs = list(
  c(1,100,2,0.016), #H+
  c(23,100), #Na+
  c(39,100,40,0.0129,41,7.221), #K+
  c(18,100,19,0.0721,20,0.2005,21,0.0001), #H2O
  c(44,100,45,1.1618,46,0.4018,47,0.0045,48,0.0004), #CO2
  c(17,100,18,0.4093,19,0.0002), #NH3
  c(46,100,47,1.1938,48,0.4022,49,0.0046,50,0.0004), #HCOOH
  c(60,100,61,2.3073,62,0.4158,63,0.0091,64,0.0004), #CH3COOH
  c(41,100,42,2.5725,43,0.0207), #CH3CN
  c(32,100,33,1.1857,34,0.2016,35,0.0023), #CH3OH
  c(28,100,29,1.1217,30,0.2009,31,0.0022), #cO
  c(98,100,99,0.2084,100,0.8021,101,0.0013,102,0.0024) #H3PO4
)
